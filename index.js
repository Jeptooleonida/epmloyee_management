  ...
  function addRole() {
    inquirer
      .prompt({
        type: "input",
        name: "title",
        message: "Input role name of the new role?",
      })
      .then((titleAnswer) => {
        ...
        return inquirer
          ...
          .then((salaryAnswer) => {
            ...
            return db.viewAllDepartments().then(([departments]) => {
                ...
                .prompt([
                  {
                    type: "list",
                    name: "department_id", 
                    message: "Input the department in which the role belongs to?",
        ...
        .then(([roles]) => {
          ...
          return inquirer
            ...
            .then((roleAnswer) => {
              ...
              console.log(
                `Updating role for employee ID ${employeeId} to new role ID ${newRoleId}`
              );
